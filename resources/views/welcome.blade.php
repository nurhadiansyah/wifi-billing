...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('assets1/images/favicon.png') }}?v=2">
    <!-- Bootstrap 4 -->
							...
							<div class="row text-center">
								<div class="col-12 col-md-10 col-lg-8 mx-auto text-white">
                                    ...
                                    <div class="ez-animate d-flex justify-content-center align-items-center flex-wrap" data-animation="fadeInUp">
                                        <a href="#section-pricing1" class="btn btn-light scroll-down mb-3 mb-sm-0 mr-sm-3" style="font-weight: 700; font-size: 16px; padding: 15px 40px; border-radius: 50px; color: #6366f1; text-transform: uppercase; letter-spacing: 1px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">Lihat Paket</a>
                                        <a href="https://wa.me/6285256486282" class="btn mb-3 mb-sm-0" style="font-weight: 700; font-size: 16px; padding: 13px 40px; border-radius: 50px; background-color: transparent; border: 2px solid #fff; color: #fff; text-transform: uppercase; letter-spacing: 1px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);"><i class="fa fa-whatsapp mr-2 fa-lg"></i>Hubungi Kami</a>
                                    </div>
								</div>
							</div>
						</div>
