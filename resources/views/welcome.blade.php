							...
							<div class="row text-center">
								<div class="col-12 col-md-10 col-lg-8 mx-auto text-white">
                                    ...
                                    <div class="ez-animate d-flex justify-content-center align-items-center flex-wrap" data-animation="fadeInUp">
                                        <a href="#section-pricing1" class="btn-1 shadow1 style3 scroll-down mb-3 mb-sm-0 mr-sm-3 d-inline-flex align-items-center justify-content-center" style="font-weight: 700; font-size: 16px; padding: 0 40px; height: 55px; border-radius: 50px; background-color: #fff; color: #6366f1; text-transform: uppercase; letter-spacing: 1px;">Lihat Paket</a>
                                        <a href="https://wa.me/6285256486282" class="btn-1 shadow1 style3 mb-3 mb-sm-0 d-inline-flex align-items-center justify-content-center" style="font-weight: 700; font-size: 16px; padding: 0 40px; height: 55px; border-radius: 50px; background-color: transparent; border: 2px solid #fff; color: #fff; text-transform: uppercase; letter-spacing: 1px;"><i class="fa fa-whatsapp mr-2 fa-lg" style="margin-top: -2px;"></i>Hubungi Kami</a>
                                    </div>
								</div>
							</div>
						</div>
